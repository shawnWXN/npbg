...
public class TestRecordSqlProvider {
    ...
    public String getRecordsFromITMS(LinkedHashMap<String, Object> lineConfig, int lineId, int stationId, LocalDateTime startTime, LocalDateTime endTime){
        String lineName = Func.getNameBySeq(lineConfig, lineId);
        String stationName = Func.getNameBySeq(lineConfig, lineId, stationId);
        ...
        String controllerStr = "contrll,1con1";
